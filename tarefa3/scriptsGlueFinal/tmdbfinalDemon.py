...
raw_data = glueContext.create_dynamic_frame.from_options(
    connection_type="s3",
    connection_options={"paths": ["s3://theclown/raw/tmdb/json/2024/01/27/tmdb_data_85937.json"]},
    format="json"
)

# Selecione apenas as colunas desejadas
processed_data = raw_data.select_fields(["name", "first_air_date", "popularity", "production_companies", "vote_average", "episode_run_time", "genres", "origin_country", "season_number", "networks", "air_date"])
