...
raw_data = glueContext.create_dynamic_frame.from_options(
    connection_type="s3",
    connection_options={"paths": ["s3://theclown/raw/tmdb/json/2024/01/27/tmdb_data_30981.json"]},
    format="json"
)

# Selecione apenas as colunas desejadas
processed_data = raw_data.select_fields(["name", "popularity", "genres", "runtime", "vote_average", 
                                         "original_language", "origin_country", "networks", 
                                         "overview", "production_companies", "first_air_date", 
                                         "number_of_episodes"])
